...
public class CollectionsAlgorithmMethodsDemo7 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Collections.min(studentList, new StudentMarksComparator()));
		System.out.println(Collections.max(studentList, new StudentMarksComparator()));
